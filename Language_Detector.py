...
# Loading the dataset
data = pd.read_csv("Data-Set/Language_Detection.csv")
...
def predict(text):
    ...
    return f"The langauge is in {lang[0]}"
    
#print(predict("Analytics Vidhya provides a community based knowledge portal for Analytics and Data Science professionals"))
